...
class GUI:
    def __init__(self, root):
        ...
        # إضافة صورة خلفية
        self.background_image = Image.open("Sign lang ar\AI.jpg")  # قم بتغيير اسم الصورة إلى اسم الصورة الخاصة بك
        ...
        load_button = tk.Button(root, text="تحميل فيديو", font=("Helvetica", 15), command=self.load_file, width=30, height=1, bg="#2ecc71", fg="white")
    ...
    def load_file(self):
        # فتح نافذة لاختيار الصورة أو الفيديو
        file_path = filedialog.askopenfilename(filetypes=[("Image files", "*.mp4;*.avi")])
